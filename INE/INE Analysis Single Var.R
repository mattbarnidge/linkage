...
x$att = with(x, rowMeans(cbind(scale(mot), 
                               scale(int), 
                               scale(fol), 
                               scale(alg), 
                               scale(cur)), na.rm=TRUE))
...
par(mfrow=c(1,1))
visreg::visreg(am, "att", jitter=TRUE, line=list(col="black"),
...
#Visualizations
par(mfrow=c(2,2))
visreg::visreg(lm1, "att", jitter=TRUE, line=list(col="black"),
               main="Trait-Like DV", ylab="Incidental Exposure", xlab="")
visreg::visreg(lg1, "att", jitter=TRUE, line=list(col="black"), 
               main="State-Like DV", ylab="Incidental Exposure", xlab="")
visreg::visreg(lm2, "att", jitter=TRUE, line=list(col="black"), 
               ylab="Total Exposure", xlab="Involvement")
visreg::visreg(lg2, "att", jitter=TRUE, line=list(col="black"),
...
#Fit models
lg3 = lmer(story.engage ~ att*incexp + 
             age.c + female.c + poc.c + edu.c + inc.c + ideo.c + pid.c + 
           ...
           control=lmerControl(optimizer="bobyqa",
                               optCtrl=list(maxfun=2e5)))
lg4 = lmer(story.engage.he ~ att*incexp + 
             age.c + female.c + poc.c + edu.c + inc.c + ideo.c + pid.c + 
             sm.freq.c + size.c + div.c + grp.c + ipe.c +
             (1 | frame), 
           data=subset(x, recall==1),
...
#Refit models
lg3.v = lmer(story.engage ~ att*incexp + 
               age.c + female.c + poc.c + edu.c + inc.c + ideo.c + pid.c + 
               sm.freq.c + size.c + div.c + grp.c + ipe.c +
             (1 | frame), 
           data=subset(x, recall==1),
           control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
lg4.v = lmer(story.engage.he ~ att*incexp + 
               age.c + female.c + poc.c + edu.c + inc.c + ideo.c + pid.c + 
               sm.freq.c + size.c + div.c + grp.c + ipe.c +
             (1 | frame), 
           data=subset(x, recall==1),
...
#Visualizations
par(mfrow=c(1,1))
visreg::visreg(lg3.v, "att", by="incexp", jitter=TRUE, line=list(col="black"), 
               ylab="Engagement", xlab="Exposure Type")
visreg::visreg(lg4.v, "att", by="incexp", jitter=TRUE, line=list(col="black"), 
